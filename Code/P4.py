...
for hashtag in hashtagLinReg:
    ...
    print('The average prediction error for %s is %f' % (hashtag, errorPrediction / kFold))
    ...
    print('The average prediction error for %s in period 1 is %f' % (hashtag, errorPrediction / kFold))
    ...
    print('The average prediction error for %s in period 2 is %f' % (hashtag, errorPrediction / kFold))
    ...
    print('The average prediction error for %s in period 3 is %f' % (hashtag, errorPrediction / kFold))
